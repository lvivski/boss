...
BEMSSTranslator.prototype["clazz"] = function $clazz() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["number"] = function $number() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["comment"] = function $comment() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["string"] = function $string() {
    var x, y;
    return this._list(function() {
...
BEMSSTranslator.prototype["raw"] = function $raw() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["uri"] = function $uri() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["stylesheet"] = function $stylesheet() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["block"] = function $block() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["declaration"] = function $declaration() {
    var x, y;
    return this._list(function() {
...
BEMSSTranslator.prototype["simpleselector"] = function $simpleselector() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["selector"] = function $selector() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["ruleset"] = function $ruleset() {
    var x, y;
    return this._list(function() {
...
BEMSSTranslator.prototype["ident"] = function $ident() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["pseudoc"] = function $pseudoc() {
    var x;
    return this._list(function() {
...
BEMSSTranslator.prototype["functionBody"] = function $functionBody() {
    ...
    return this._list(function() {
        ...
        var args = new nodes.Arguments, list;
        x.forEach(function(node) {
            if (node === " ") return;
            if (node === ",") {

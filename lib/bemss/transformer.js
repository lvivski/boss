...
BEMSSTransformer.prototype["ruleset"] = function $ruleset() {
    var t, x, y;
    return this._list(function() {
...
BEMSSTransformer.prototype["variable"] = function $variable() {
    var t, v;
    return this._list(function() {
...
BEMSSTransformer.prototype["string"] = function $string() {
    var t, x, y;
    return this._list(function() {

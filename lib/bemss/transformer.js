...
var BEMSSTransformer = function BEMSSTransformer(source) {
    CSSTransformer.call(this, source);
};

BEMSSTransformer.grammarName = "BEMSSTransformer";

BEMSSTransformer.match = CSSTransformer.match;

BEMSSTransformer.matchAll = CSSTransformer.matchAll;

exports.BEMSSTransformer = BEMSSTransformer;

require("util").inherits(BEMSSTransformer, CSSTransformer);

BEMSSTransformer.prototype["any"] = function $any() {
...
BEMSSTransformer.prototype["assignment"] = function $assignment() {
    var t, x, y;
...
BEMSSTransformer.prototype["definition"] = function $definition() {
    var t, x, y;
    return this._list(function() {
        return this._match("definition") && (t = this._getIntermediate(), true) && this._rule("any", false, [], null, this["any"]) && (x = this._getIntermediate(), true) && this._rule("any", false, [], null, this["any"]) && (y = this._getIntermediate(), true);
    }) && this._exec([ t, x, y ]);
};

BEMSSTransformer.prototype["binary"] = function $binary() {
    var t, o, x, y;
    return this._list(function() {
        return this._match("binary") && (t = this._getIntermediate(), true) && this._skip() && (o = this._getIntermediate(), true) && this._rule("any", false, [], null, this["any"]) && (x = this._getIntermediate(), true) && this._rule("any", false, [], null, this["any"]) && (y = this._getIntermediate(), true);
    }) && this._exec([ t, o, x, y ]);
};

BEMSSTransformer.prototype["unary"] = function $unary() {
    var t, o, x;
    return this._list(function() {

...
BEMSSParser.prototype["definition"] = function $definition() {
    var x, y, z;
    return this._rule("ident", false, [], null, this["ident"]) && (x = this._getIntermediate(), true) && this._match("(") && this._rule("functionBody", false, [], null, this["functionBody"]) && (y = this._getIntermediate(), true) && this._match(")") && this._any(function() {
        return this._atomic(function() {
